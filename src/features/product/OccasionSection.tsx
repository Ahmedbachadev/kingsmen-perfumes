...
const metrics = [
  { label: 'Season', value: 'Autumn / Winter', desc: 'Optimized for cooler weather & evening air.', icon: Calendar },
  { label: 'Occasion', value: 'Evening & Black Tie', desc: 'Designed to command presence.', icon: Moon },
  { label: 'Longevity', value: '12+ Hours', desc: 'High concentration Extrait formulation.', icon: Clock },
  { label: 'Silllage', value: 'Enormous', desc: 'Leaves a captivating, refined trail.', icon: Flame },
];
