...
export default function NewslettersPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-neutral-900 ">Newsletters</h1>
 <p className="text-sm text-neutral-500 mt-1">Manage your newsletters.</p>
 </div>
 ...
 This module has been scaffolded for Newsletters. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
