...
export default function HomepagePromotionsPage() {
 return (
 <div className="p-6">
 <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
 <div>
 <h1 className="text-2xl font-bold text-neutral-900 ">HomepagePromotions</h1>
 <p className="text-sm text-neutral-500 mt-1">Manage your homepagepromotions.</p>
 </div>
 ...
 This module has been scaffolded for HomepagePromotions. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
