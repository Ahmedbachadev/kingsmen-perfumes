...
export default function SubscribersPage() {
 ...
 <p className="text-sm text-neutral-500 mt-1">Manage your subscribers.</p>
 </div>
 ...
 This module has been scaffolded for Subscribers. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
