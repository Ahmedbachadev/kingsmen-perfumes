...
export default function CampaignAnalyticsPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-neutral-900 ">CampaignAnalytics</h1>
 <p className="text-sm text-neutral-500 mt-1">Manage your campaignanalytics.</p>
 </div>
 ...
 This module has been scaffolded for CampaignAnalytics. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
