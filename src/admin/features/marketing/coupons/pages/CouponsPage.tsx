...
export default function CouponsPage() {
 ...
 <p className="text-sm text-neutral-500 mt-1">Manage your coupons.</p>
 </div>
 ...
 This module has been scaffolded for Coupons. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
