...
export default function FeaturedCollectionsPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-neutral-900 ">FeaturedCollections</h1>
 <p className="text-sm text-neutral-500 mt-1">Manage your featuredcollections.</p>
 </div>
 ...
 This module has been scaffolded for FeaturedCollections. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
