...
export default function CustomersPage() {
 ...
 <p className="text-sm text-neutral-500 mt-1">Manage your customers.</p>
 </div>
 ...
 This module has been scaffolded for Customers. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
