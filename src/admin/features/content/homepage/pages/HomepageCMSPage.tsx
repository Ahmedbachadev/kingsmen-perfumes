...
export default function HomepageCMSPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-neutral-900 ">HomepageCMS</h1>
 <p className="text-sm text-neutral-500 mt-1">Manage your homepagecms.</p>
 </div>
 ...
 This module has been scaffolded for HomepageCMS. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
