...
export default function TestimonialsPage() {
 ...
 <p className="text-sm text-neutral-500 mt-1">Manage your testimonials.</p>
 </div>
 ...
 This module has been scaffolded for Testimonials. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
