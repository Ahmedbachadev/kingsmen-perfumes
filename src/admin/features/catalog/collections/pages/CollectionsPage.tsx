...
export default function CollectionsPage() {
 ...
 <p className="text-sm text-neutral-500 mt-1">Manage your collections.</p>
 </div>
 ...
 This module has been scaffolded for Collections. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
