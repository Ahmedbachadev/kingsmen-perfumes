...
export default function CategoriesPage() {
 ...
 <p className="text-sm text-neutral-500 mt-1">Manage your categories.</p>
 </div>
 ...
 This module has been scaffolded for Categories. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
