...
export default function MediaLibraryPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-neutral-900 ">MediaLibrary</h1>
 <p className="text-sm text-neutral-500 mt-1">Manage your medialibrary.</p>
 </div>
 ...
 This module has been scaffolded for MediaLibrary. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
