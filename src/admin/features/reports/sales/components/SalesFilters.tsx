...
import type { SalesFilters as FilterType, DateRangePreset } from '../types';
...
export const SalesFilters: React.FC<SalesFiltersProps> = ({ filters, onChange }) => {
 ...
 <div>
 <label className="block text-xs text-neutral-500 mb-1">Order Status</label>
 <select 
 className="w-full bg-neutral-50 border border-neutral-200 rounded-lg px-3 py-1.5 text-sm outline-none"
