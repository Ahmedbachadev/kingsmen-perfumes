...
export default function CustomerReportsPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-neutral-900 ">CustomerReports</h1>
 <p className="text-sm text-neutral-500 mt-1">Manage your customerreports.</p>
 </div>
 ...
 This module has been scaffolded for CustomerReports. Full CRUD functionality will be implemented soon.
 </p>
 </div>
 </div>
 </div>
